    ...
    >
      ...
      >
        ...
        >
          <Link
            href="/courses"
            className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-white px-8 py-4 text-xs font-black uppercase tracking-[0.2em] text-[#03131d] shadow-[0_4px_30px_rgba(255,255,255,0.15)] transition-all duration-300 hover:scale-105 hover:shadow-[0_10px_40px_rgba(34,211,238,0.4)]"
          >
          ...
          <Link
            href="/contact"
            className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full border border-white/20 bg-white/5 px-8 py-4 text-xs font-black uppercase tracking-[0.2em] text-white backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-white/10 hover:border-white/40"
          >
